...
\begin{document}%
%
\begin{tikzpicture}[scale = 1, z={(-15:10mm)},x={(40:5mm)}]
    %
    \def\comradius{.6em};%
    %
    ...
    \tikzstyle{spring} = [decoration = {coil, aspect = 0.5,  segment length = .3em,  amplitude = .3em,  pre length = 2em, post length = 1.5em}, decorate, thick, draw = TUMBlack]%
    %
    ...
    \begin{scope}[canvas is zx plane at y = -2]
        ...
        \node at (3.25, -4.75) [align=center, text = TUMBlue] {double\\support};
    \end{scope}
    %
    ...
    \begin{scope}[canvas is zy plane at x = 0]
        ...
        \node at (8.5, .75) [text = TUMOrange, transform shape] {center of mass trajectory}; % (x, y)
    \end{scope}
    %
    % Axes
    \begin{scope}
