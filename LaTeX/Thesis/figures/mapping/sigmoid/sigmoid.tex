...
\begin{tikzpicture}[scale = 1]
    ...
    \datavisualization [
      scientific axes, 
      visualize as line/.list = {1.5,2,2.5},
      style sheet = vary dashing,
      1.5 = {style = {ultra thick, TUMOrange}, label in legend = {text = {$\gls{k} = 0.15,~\gls{d} = 4$}}},
      2 = {style = {ultra thick, TUMGreen}, label in legend = {text = {$\gls{k} = 0.2,~\gls{d} = 4$}}},
      2.5 = {style = {ultra thick, TUMBlue}, label in legend = {text = {$\gls{k} = 0.25,~\gls{d} = 4$}}},
      all axes = {grid},
      x axis = {label = {$\gls{rho}~\left[\si{\degree}\right]$}},
      y axis = {include value = -7.5, include value = -27.5, label = {\glsxtrshort{aea}$~\left[\si{\degree}\right]$}}]
    data [format = function] {
      var set : {1.5, 2, 2.5};
      var x : interval [-60:-5];
      func y = ( 15 / (1 + exp((\value{set} / 10)  * \value x + 4))) - 25;
    };
    %
\end{tikzpicture}%
%
