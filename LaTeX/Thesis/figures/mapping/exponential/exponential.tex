...
\begin{tikzpicture}[scale = 1]
    ...
    \datavisualization [
      ...
      2 = {style = {ultra thick, TUMOrange}, label in legend = {text = $\frac{200}{\gls{rho}} - 6$}},
      3 = {style = {ultra thick, TUMGreen}, label in legend = {text = $\frac{300}{\gls{rho}} - 6$}},
      4 = {style = {ultra thick, TUMBlue}, label in legend = {text = $\frac{400}{\gls{rho}} - 6$}},
      all axes = {grid},
      x axis = {label = {$\gls{rho}~\left[\si{\degree}\right]$}},
      y axis = {include value = 0, label = {\glsxtrshort{aea}$~\left[\si{\degree}\right]$}}]
    data [format = function] {
      var set : {2,...,4};
      var x : interval [-60:-5];
      func y = (\value{set} * 100 / \value x) - 6;
    };
    %
\end{tikzpicture}%
%
